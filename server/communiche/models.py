...
class Community(models.Model):
        ...
        if is_new:
            ...
            if default_template:
                ...
                TemplateCommunity.objects.create(
                    template=default_template, community=self
                )
    ...
    reputation_rating = models.DecimalField(
        max_digits=10, decimal_places=1, default=0, null=True
    )
    owner = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="owner", null=True
    )
    members = models.ManyToManyField(
        User, through="CommunityUser", related_name="communities"
    )
...
class Template(models.Model):
    ...
    community = models.ForeignKey(
        Community, on_delete=models.CASCADE, related_name="templates", null=True
    )
